...
export function getApiUnavailableMessage(): string {
  ...
  return 'API not available. Add GITHUB_TOKEN, GITHUB_OWNER, and GITHUB_REPO in your host’s environment (e.g. Vercel → Settings → Environment Variables), then redeploy.';
}
